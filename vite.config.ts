    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          // Since the VitePWA `base` property is set to /ch5-vue-ts-template/
          // the path will resolve to https://ip/ch5-vue-ts-template/assets/vite.png
          icons: [
            {
              src: './assets/vite.png',
              sizes: '800x800',
          ...
          // The src property is relative to the index.html path at runtime.
          // Since the VitePWA `base` property is set to /ch5-vue-ts-template/
          // the path will resolve to https://ip/ch5-vue-ts-template/assets/screenshot_something.png
          screenshots: [
            {
